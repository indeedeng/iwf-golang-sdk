...
type Client interface {
	...
	// options is more detailed options, only workflowTimeoutSeconds is required -- it includes like IdReusePolicy, RetryPolicy, CronSchedule and also WorkflowStateOptions for the startState
	StartWorkflow(ctx context.Context, workflow interface{}, startStateId, workflowId string, options WorkflowOptions) (string, error)
	...
	// workflowId is required, workflowRunId is optional and default to current runId of the workflowId
	// resetWorkflowTypeAndOptions is required, it provides combination parameter for reset
