...
type _WorkflowDumpRequest WorkflowDumpRequest
...
func (o *WorkflowDumpRequest) UnmarshalJSON(bytes []byte) (err error) {
	...
	varWorkflowDumpRequest := _WorkflowDumpRequest{}

	err = json.Unmarshal(bytes, &varWorkflowDumpRequest)

	if err != nil {
		return err
	}

	*o = WorkflowDumpRequest(varWorkflowDumpRequest)
