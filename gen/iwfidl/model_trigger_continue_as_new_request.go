...
type _TriggerContinueAsNewRequest TriggerContinueAsNewRequest
...
func (o *TriggerContinueAsNewRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varTriggerContinueAsNewRequest := _TriggerContinueAsNewRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varTriggerContinueAsNewRequest)

	if err != nil {
		return err
	}

	*o = TriggerContinueAsNewRequest(varTriggerContinueAsNewRequest)
