...
type _SignalCommand SignalCommand
...
func (o *SignalCommand) UnmarshalJSON(bytes []byte) (err error) {
	...
	varSignalCommand := _SignalCommand{}

	err = json.Unmarshal(bytes, &varSignalCommand)

	if err != nil {
		return err
	}

	*o = SignalCommand(varSignalCommand)
